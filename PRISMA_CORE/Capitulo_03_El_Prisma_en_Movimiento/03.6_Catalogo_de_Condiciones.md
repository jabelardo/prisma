...
El personaje está atrapado en su sitio y no puede moverse. Esto puede ser porque ha sido atado, gravemente herido o se encuentra atrapado en barro, escombros, etc.
* **Efecto:** El personaje no puede realizar ninguna [acción de movimiento](../03.2.3_Tipos_de_Acciones_y_Tareas.md) basada en el desplazamiento físico (habilidades como la teletransportación, si existen, están permitidas).
* **Resolución:** El personaje gasta una [Acción Simple](../03.2.3_Tipos_de_Acciones_y_Tareas.md) para liberarse de lo que sea que impedía su movimiento.
...
Esta Condición se aplica cuando las personas son golpeadas por un arma o drogadas con algo que contenga una cualidad anestésica o sedante.
* **Efecto:**
    * Aunque el daño recibido permanece y sus consecuencias físicas se acumulan, el personaje no puede sentirlo (y puede que ni siquiera lo note inmediatamente).
    * El personaje no obtiene ningún beneficio que pudiera derivarse de estar [Herido](../???)(como podría ser la obtención de [Filo](../Capitulo_01_Mecanicas_Fundamentales/01.05_Filo.md) por desesperación, activación de ciertas Ventajas, etc., según defina el DJ o reglas específicas).
    * El dolor no actúa como una distracción o compulsión para este personaje bajo ninguna circunstancia.
    * Si está bajo esta Condición, un personaje no puede ganar la Condición "[Agonía](#agonía)" y la pierde inmediatamente si ya la poseía.
* **Resolución:** El personaje se beneficia de primeros auxilios (una acción exitosa de [Medicina](../Capitulo_02_Creacion_y_Progresion_de_Personajes/02.5.2_Lista_Detallada_de_Habilidades/02.5.2.12_Habilidad_Medicina.md)), o la Condición termina al finalizar la escena (cuando el efecto del shock o la droga puede empezar a disiparse y el dolor real podría aparecer).

### Inspirado

El personaje ha sido inspirado a actuar por otro.
* **Efecto:** Cuando el personaje realiza la acción específica que el personaje inspirador le incitó a llevar a cabo, gana **+3 [Filo](../Capitulo_01_Mecanicas_Fundamentales/01.05_Filo.md)** para su tirada en dicha acción. 
* **Resolución:** Esta Condición se resuelve inmediatamente después de que el personaje realiza la acción para la cual fue inspirado.
...
El cuerpo de un personaje licuado se ha convertido en un fluido viscoso.
* **Efecto:**
    * Mientras está en este estado, el personaje se considera que tiene **+2 Rangos de [Escala de Poder](../03.2.5_Escalas_de_Poder.md) para propósitos de Durabilidad** contra ataques entrantes (la [Dificultad](../Capitulo_01_Mecanicas_Fundamentales/01.06_Dificultad.md) para que los ataques le afecten aumenta en +2).
    * El personaje no puede iniciar ataques que no sean de Combate Cercano.
    * Al usar Combate Cercano mientras está licuado, un personaje solo puede comprar la [Treta de Combate](../03.3_Escenas_de_Accion_y_Aventura.md#tretas-de-accion-y-combate)"Derribar/Zancadilla". Incluso las Tretas de Combate Universales le están negadas.
    * Cuando un personaje licuado compra "Derribar/Zancadilla", el objetivo cae sobre el personaje. Dependiendo de la naturaleza de su forma, tal contacto puede causar [Heridas](./???)adicionales o infligir [Condiciones](#catálogo-de-condiciones).
    * Una criatura licuada puede moverse a través de huecos tan pequeños como 1 milímetro y puede deslizarse por suelos o bajar paredes o escaleras a voluntad, moviéndose a su velocidad normal.
    * Una criatura licuada no puede ganar la Condición "[Sujetado](#sujetado)".
* **Resolución:**
    * Si el personaje eligió volverse licuado (mediante un poder o habilidad): la Condición dura lo descrito en dicho poder o hasta que el personaje elija terminarla usando una [Acción Simple](../03.2.3_Tipos_de_Acciones_y_Tareas.md) de [Supervivencia](../Capitulo_02_Creacion_y_Progresion_de_Personajes/02.5.2_Lista_Detallada_de_Habilidades/02.5.2.15_Habilidad_Supervivencia.md) o [Esotérica](../Capitulo_02_Creacion_y_Progresion_de_Personajes/02.5.2_Lista_Detallada_de_Habilidades/02.5.2.09_Habilidad_Esoterica.md) (con [Dificultad](../Capitulo_01_Mecanicas_Fundamentales/01.06_Dificultad.md) 2).
    * Si el personaje fue licuado contra su voluntad: el efecto dura un número de rondas igual a **1 más cualquier [Acierto](../Capitulo_01_Mecanicas_Fundamentales/01.04_Aciertos_y_Tipos_de_Exito.md) adicional** obtenido en la tirada de acción que infligió la Condición. Restaurar a un personaje licuado a la solidez requiere una [Acción Simple](../03.2.3_Tipos_de_Acciones_y_Tareas.md) de [Medicina](../Capitulo_02_Creacion_y_Progresion_de_Personajes/02.5.2_Lista_Detallada_de_Habilidades/02.5.2.12_Habilidad_Medicina.md) o [Esotérica](../Capitulo_02_Creacion_y_Progresion_de_Personajes/02.5.2_Lista_Detallada_de_Habilidades/02.5.2.09_Habilidad_Esoterica.md) (con [Dificultad](../Capitulo_01_Mecanicas_Fundamentales/01.06_Dificultad.md) 3) realizada por otro personaje o por él mismo si logra actuar.
