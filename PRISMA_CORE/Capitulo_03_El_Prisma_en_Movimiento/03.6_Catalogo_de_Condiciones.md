...
El personaje se siente culpable por sus acciones y cree que debe expiar sus fechorías.
* **Efecto:** Cada vez que el personaje realiza una acción que no está destinada a expiar su culpa, si es un PJ sufre una **Complicación Menor (1)**. Si no supera la Complicación, su actitud hacia la persona o institución por la que se siente culpable se vuelve más positiva. Si el personaje es un PNJ que actúa contra un PJ, el PJ gana **+1 Filo** en la acción de reacción y si el PJ supera la reacción la actitud del PNJ se vuelve más positiva. Si la actitud ya es positiva, forma un nuevo [Vínculo](./../Capitulo_02_Creacion_y_Progresion_de_Personajes/02.3.3_Camino_de_Vinculo.md) de simpatía de 1 punto hacia el personaje o aumenta un Vínculo existente en 1 paso.
...
* **Efecto:** Mientras está en este estado, aumenta su **[Escala](./03.2.5_Escalas_de_Poder.md) en +2** para Durabilidad contra ataques entrantes. El personaje no puede iniciar ataques que no sean de Combate Cercano. Al usar Combate Cercano, solo puede comprar [Tretas](./../Capitulo_01_Mecanicas_Fundamentales/01.08_Tretas.md) de Combate pero no puede infligir daño. Al comprar una Treta, vuelve a ser tangible. Una criatura gaseosa puede moverse a través de huecos tan pequeños como 1 milímetro, a su velocidad normal.
* **Resolución:** Si el personaje eligió volverse gaseoso, dura lo que diga el poder o hasta que elija terminarlo (acción de Supervivencia o Esotérica, Dificultad 2). Si fue forzado, dura 1 + Aciertos extra de la acción que lo causó. Restaurarlo requiere Medicina o Esotérica (Dificultad 3).
...
El personaje lucha contra una infección, ya sea mística o biológica, que lo devora desde dentro.
* **Efecto:** La infección comienza en 1. Cada ronda posterior, el objetivo debe superar una **Complicación Moderada (2)** en cualquier acción física o mental. No superarla aumenta la calificación de la infección en 1. Si llega a 5, el objetivo gana la Condición "Fuera de Combate" o similar.
* **Resolución:** El personaje recibe ayuda médica u oculta.
