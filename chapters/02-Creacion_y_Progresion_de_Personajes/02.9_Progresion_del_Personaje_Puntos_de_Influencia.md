...
### Inversión de Puntos de Influencia
...
| **Adquirir una Ventaja** | 3 por Punto de Ventaja de la Ventaja | El coste de una Ventaja se calcula multiplicando el coste en Puntos de Ventaja de la Ventaja (indicado en la [Lista de Ventajas](./02.X_Ventajas_de_Personaje.md)) por 3 Puntos de Influencia Personal. Por ejemplo, una Ventaja de 1 Punto de Ventaja cuesta 3 PI; una de 2 Puntos de Ventaja cuesta 6 PI. |
...
| **Subir un Camino de Nivel (por Nivel)** | 15 | Este coste es para subir un Camino existente (Origen, Rol o Vínculo) en 1 Nivel. Un Camino tiene un máximo de 5 Niveles. |
| **Adquirir un Camino Nuevo (Nivel 1)** | 15 | Un personaje no puede tener más de tres Caminos activos (uno de cada tipo) a la vez. Cuando adquieres un Camino nuevo, este se considera de Nivel 1. |

*   **Beneficios por Nivel de Camino:** Al subir de Nivel un Camino (ya sea existente o nuevo), tu personaje obtiene los siguientes beneficios:

| Nivel de Camino | Puntos de Habilidad | Puntos de Ventaja | Punto de Contacto |
| :-------------- | :------------------ | :----------------- | :---------------- |
| Nivel 1         | 3                   | 2                  | 1                 |
| Nivel 2         | 3                   | 1                  | 1                 |
| Nivel 3         | 3                   | 1                  | 1                 |
...
| Nivel 5         | 3                   | 1                  | 1                 |
    ...
    *   **Punto de Contacto:** Este punto se puede usar para mejorar en +1 la valoración de tu Conexión de Contacto de ese Camino (lo que aumenta su capacidad de uso por sesión, ver [02.3.4 Manejo de Conexiones de Camino](./02.3.4_Manejo_de_Conexiones_de_Camino.md)) o para adquirir un nuevo Contacto adicional para ese Camino (acordado con el DJ).
