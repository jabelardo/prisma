...
**Biblioteca**
*   **Nivel:** 1 a 3 PV
*   **Beneficio:** Tu personaje tiene acceso a un archivo de conocimiento poco común, ya sea una estantería llena de textos médicos, la colección privada de un museo o un disco duro de información clasificada. Tu personaje no tiene que buscar las fuentes; tiene todo el material que necesita para tiradas de [Ciencia](enlace), [Cultura](enlace) o [Enigmas](enlace) al alcance de su mano.
    *   **A Nivel 1 PV:** Esta biblioteca cubre un campo equivalente a una [Especialidad](enlace) y ofrece **+1 Filo** a las tiradas de Investigación realizadas usándola.
    *   **Cada punto de PV adicional (para alcanzar Nivel 2 o Nivel 3):** Por cada punto de Ventaja adicional invertido en esta Ventaja, puedes elegir **una** de las siguientes opciones:
        ...
        *   **Expandir el Alcance:** Amplía el alcance de la biblioteca. Si actualmente cubre una [Especialidad](enlace), ahora abarca una [Habilidad](enlace) completa (ej. Medicina, Tecnología). Si ya cubre una [Habilidad](enlace), ahora abarca un tema amplio que puede ser abordado por múltiples Habilidades (ej. Historia Oculta, Conspiraciones Mundiales).
